...
(function(root,factory){const api=factory();if(typeof module==='object'&&module.exports)module.exports=api;else root.PerspectiveModel=api;})(typeof globalThis==='object'?globalThis:this,()=>{
  ...
  function state(t,manual={}){
    ...
    return {t,chapter:c,turn,room:smooth(8,11,t)*(1-smooth(40,43,t)),rays:smooth(11,14,t)*(1-smooth(39.5,42,t)),inset:smooth(12,15,t)*(1-smooth(36,39.5,t)),compare:smooth(18,19.5,t)*(1-smooth(30,31,t)),horizon:smooth(30,32,t),art:smooth(44,47,t),artGuides:smooth(47.8,49.8,t),distance,eye,length:lerp(16,24,smooth(30,37,t))};
  }
